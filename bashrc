...
alias gr="cd ~/office/bin && gdb --args ./ToCell ../../test/ToCell_test1.xlsx --v=JKH && cd -"
alias gp="cd ~/office/bin && gdb --args ./ToPoint ../../test/PPTTest.pptx --v=JKH && cd -"
alias gw="cd ~/office/bin && gdb --args ./ToWord ../../test/WordTest.docx --v=JKH && cd -"
alias tos="cd ~ && ./tos_update.sh /home/kwanghyun/trunk && cd -"
alias cs="cscope -RC" 
alias tt="~/env/script/tmux-attach.sh"
alias go="cd ~/office/src/app/webdaemon/test/"
